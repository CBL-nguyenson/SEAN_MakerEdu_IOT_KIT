/*
  IoTStarterKit_Chuyen_Bao_Loc_2024
  Title : Xây dựng hệ thống IOT quy mô hộ gia đình trên nền tảng Blynk
  Author: Nguyễn Sơn
  Date  : 29/7/2024
*/
...
#define LED_PIN 12    // Chân điều khiển LED

#define BLYNK_TEMPLATE_ID "TMPL60Nqrr_Vx"
#define BLYNK_TEMPLATE_NAME "Den noi that"
#define BLYNK_AUTH_TOKEN "J_kNkJtUkpajotfENg5OREqSv7cQAMvX"
...
char ssid[] = "phone";  // Tên mạng Wi-Fi (chỉ hoạt động với băng tần 2.4Ghz)
char pass[] = "1234567890";         // Mật khẩu Wi-Fi


// Định nghĩa các chân Virtual Pins như trên Web BLYNK
const int Virtual_Pins_LED = 1;
const int Virtual_Pins_Relay = 2;
const int Virtual_Pins_Motor = 3;
