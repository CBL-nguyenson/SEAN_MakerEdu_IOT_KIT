...
#define BLYNK_AUTH_TOKEN "O1SI-ZwkBkjzWdiEZFGaBrb7Y4oC8RLM"  // Mã xác thực Blynk
...
void loop() {
  ...
  /*
   ...
   if (millis() - lastTimeSend >= 100) {                               // Kiểm tra nếu đã qua 100ms kể từ lần gửi cuối cùng
